  ...
  return (
    <section className="relative overflow-hidden bg-background pt-48 pb-40 px-6">
      <div
        ...
        style={{
          backgroundImage: "url(/images/bgSections/website-hero.jpg)",
      ...
      <div className="container relative mx-auto max-w-5xl">
        <div className="flex flex-col items-center text-center gap-16">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl text-pretty leading-[1.75]">
            Diseñamos sitios que convierten visitas en consultas comerciales. Cada sección cumple un rol: presentar la
            propuesta, responder objeciones y guiar al usuario hasta la acción.
          </p>
